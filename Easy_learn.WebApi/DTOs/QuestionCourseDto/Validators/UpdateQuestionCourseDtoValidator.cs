...
{
    public class UpdateQuestionCourseDtoValidator : AbstractValidator<UpdateQuestionCourseDto>
    {
        public UpdateQuestionCourseDtoValidator() 
        {
            RuleFor(q => q.Id).NotEmpty().WithMessage("شناسه سوال اجباری است").NotNull().WithMessage("شناسه سوال اجباری است");
